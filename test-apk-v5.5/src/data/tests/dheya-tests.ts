...
export const dheyaTests: Test[] = [
 //Dheya
 { id: 'dheya-jee-barch-pyq-2023-january-attempt', name: 'dheya-jee-barch-pyq-2023-january-attempt', description: 'Solve Actual PYQ from that Year', duration: DEFAULT_TEST_DURATION, questions: dheyaFreeQuestions.slice(0, 50), category: 'pyq', course: 'dheya' },
 { id: 'dheya-jee-barch-pyq-2023-april-attempt', name: 'dheya-jee-barch-pyq-2023-april-attempt', description: 'Solve Actual PYQ from that Year', duration: DEFAULT_TEST_DURATION, questions: dheyaFreeQuestions.slice(50, 100), category: 'pyq', course: 'dheya' },
