    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        {test.questions.map((question: any, index: number) => {
          // Get student's answer from attempt (stored in TestContext)
          // Note: You'll need to store answers in TestAttempt type
          const studentAnswerKey = attempt.answers?.[question.id];
          const correctAnswerKey = question.correctOption;
          
          const isCorrect = studentAnswerKey === correctAnswerKey;
          const isUnattempted = studentAnswerKey === undefined;
            ...
            >
              ...
              <div className="space-y-2">
                {['a', 'b', 'c', 'd'].map((optionKey) => {
                  ...
                  const isStudentAnswer = studentAnswerKey === optionKey;
