  ...
  },
{
...

  {
...

   {
    ...
    // IMPORTANT: Slice the TOTAL number of questions needed (50+20+5+1 = 76)
    questions: foundationlatestQuestions.slice(1145,1222),
    sections: [
      // Section 1: Aptitude (Indices 0-49)
      {
        id: "aptitude",
  ...
  },
  {
    ...
    name: 'Foundation: Mock 22 Easy (April 2026)',
    description: 'Solve the expected paper of this year',
    duration: DEFAULT_TEST_DURATION,
  ...
  {
    id: 'foundation-latest-full-mock-April-4 ( 3.30hr )',
    name: 'Foundation: Full Mock 4 (April 2026)', // Note only description is different in original file, keeping ID same as original though it's likely a bug
    description: 'Complete B.Arch Pattern: Aptitude + Math + Drawing',
    duration: 12600, // 3.30 hours (10800 seconds)
    category: 'latest',
    course: 'foundation',

    // IMPORTANT: Slice the TOTAL number of questions needed (50+20+5+2 = 76)
    questions: foundationlatestQuestions.slice(2022,2099),
    sections: [
      // Section 1: Aptitude (Indices 0-49)
      {
        id: "aptitude",
